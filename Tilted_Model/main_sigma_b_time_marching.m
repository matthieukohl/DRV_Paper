...
R = [0.001,0.005,0.01,0.05,0.1,0.2,0.4,0.6,0.8,0.9,0.95,0.97,0.99,1.0];

%R = [0.01,0.05,0.1,0.2,0.4,0.6,0.8,0.9,0.95,0.97,0.99,1.0];
...
% legend boxoff
% title('PV-Budget Low')
% %saveas(gcf,'/disk7/mkohl/Mode_Zurita_Gotor/Plots_Proposal_Main/Large_Domain/PV_Budget_DRV_q2_r001_HD','epsc')
% close all;
...
%save('DRV_Paper/Time_Marching_L32pi_N1200_more_values','R','N','L','sigma','b')
