...
%load('mode_or_drv/mode_or_drv_N300_L12pi_t400_new.mat')

% set all the stable modes to NaN values

mode_or_drv(sigma<0.04) = NaN;
...
subplot(1,3,1)
contourf(hh,RR,mode_or_drv,[1 -1],'Edgecolor','none'); hold on
...
annotation('textbox', [0.29, 0.89, 0, 0], 'string', 'Mode','fontsize',12)
annotation('textbox', [0.24, 0.73, 0, 0], 'string', 'DRV','fontsize',12)
annotation('textbox', [0.29, 0.52, 0, 0], 'string', 'Stable','fontsize',12)
...
%load('mode_or_drv/mode_or_drv_h1_vs_h2_fixed_r01_N300_L12pi_t400.mat')


% set NaN for all negative growth rates

mode_or_drv(sigma<0.05) = NaN;
...
%load('mode_or_drv/mode_or_drv_h1_vs_h2_fixed_r001_N300_L12pi_t400.mat')
